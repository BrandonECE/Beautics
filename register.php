    ...
    <div class="container__directflex__login">
        ...
        <section class="container__box__login">
            ...
            <header class="container__box__login__header">
                ...
                <h2 class="container__box__login__header__title">Crear cuenta</h2>
            ...
            <form class="container__box__login__form" method="POST" action="./app/actions/users/register.php">
                ...
                <div class="container__box__login__form__containerdiv">
                    ...
                    <div class="container__box__login__form__boxdiv">
                        ...
                        <div class="container__box__login__form__containerimginput">
                            ...
                            <input type="text" id="inputname" name="nombre" class="container__box__login__form__input" >
                    ...
                    <div class="container__box__login__form__boxdiv">
                        ...
                        <div class="container__box__login__form__containerimginput">
                            ...
                            <input type="number" id="inputtel" name="telefono" class="container__box__login__form__input" >
                    ...
                    <div class="container__box__login__form__boxdiv">
                        ...
                        <label for="inputdirr">Direccion:</label>
                        ...
                        <div class="container__box__login__form__containerimginput">
                            ...
                            <input type="text" id="inputdirr" name="direccion" class="container__box__login__form__input" >
                    ...
                    <div class="container__box__login__form__containerdiv">
                        ...
                        <div class="container__box__login__form__boxdiv">
                            ...
                            <div class="container__box__login__form__containerimginput">
                                ...
                                <input type="password" id="inputpassword" name="r_passw" class="container__box__login__form__input" >
                ...
                <div class="container__box__login__form__containerdiv container__box__login__form__containerdiv--button">
                    ...
                    <a href="login.html" class="container__box__login__form__containerdiv__a">Ya estás Registrado?</a>

                    <button class="container__box__login__form__button">Registrar</button>
